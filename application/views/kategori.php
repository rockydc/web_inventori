    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <div class="d-sm-flex justify-content-between align-items-center mb-4 table-header">
                <h2 class="text-dark mb-0">Kategori Master</h2>

                <div class="d-none d-sm-inline-block">

                    <a class="btn btn-primary btn-sm  print-button" role="button" href=" <?= base_url(); ?>CrudKategori/export_excel"><i class="fas fa-download fa-sm text-white-50"></i>&nbsp;Generate Report As Excel</a>
                    <a class="btn btn-primary btn-sm  print-button" role="button" href=" <?= base_url(); ?>CrudKategori/export_pdf"><i class="fas fa-download fa-sm text-white-50"></i>&nbsp;Generate Report As PDF</a>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        var table = $("#mytable").dataTable({
            ...
            ajax: {
                "url": "<?php echo base_url() . 'index.php/CrudKategori/get_produk_json' ?>",
                "type": "POST"
            },
            columns: [{
                    "data": "id_kategori",
